		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Skill Tracker",
									"targetURL": "#skilltrackerui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"skilltrackerui5-display": {
								"semanticObject": "skilltrackerui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=skilltrackerui5",
									"url": sap.ui.require.toUrl("skilltrackerui5")
								}
							}
						}
					}
